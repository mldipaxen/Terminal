...
class PassControlApp(QWidget):
    def __init__(self):
        ...
        self.RadioButton = QRadioButton("Машина")

        self.issue_pass_button2 = QPushButton('Добавить временный пропуск')
        self.issue_pass_button = QPushButton('Зашел')
        ...
        self.name = QLineEdit(self, placeholderText="Почта")
        ...
        if self.car == 1:
            if sotryd != 0:
                ...
                if self.rows.count((self.name.text(),)):
                    print("Сотрудник", self.poch, "Зашёл")
                else:
                    print("Такого сотрудника нет в базе")
                base.commit()

            else:
                print("Нет мест на парковке")
        elif self.car == 0:
...
class App(QWidget):
    def __init__(self):
        ...
        self.issue_pass_button2 = QPushButton('Выдать временный пропуск на вход')
        self.issue_pass_button = QPushButton('Выдать пропуск на выход')
        self.RadioButton = QRadioButton("Машина")
        ...
        self.exit = QLineEdit(self, placeholderText="Контактная почта")
